...
<head>
    ...
    <title><?php echo $page_title ?? 'Website Informatif Dinamis'; ?></title>
    <meta name="description" content="<?php echo $meta_description ?? 'Website informatif yang dibuat dengan PHP dan MySQL.'; ?>">
...
<body>
    <header>
        <div class="container">
            ...
            <nav class="desktop-nav">
                ...
                <a class="nav-link <?php echo ($current_page == 'kategori') ? 'active' : ''; ?>" href="kategori.php">
                ...
                <a class="nav-link <?php echo ($current_page == 'tentang') ? 'active' : ''; ?>" href="tentang.php">
    ...
    <nav class="mobile-nav">
        ...
        <a class="nav-link <?php echo ($current_page == 'kategori') ? 'active' : ''; ?>" href="kategori.php">Kategori</a>
        <a class="nav-link <?php echo ($current_page == 'tentang') ? 'active' : ''; ?>" href="tentang.php">Tentang</a>
    </nav>
